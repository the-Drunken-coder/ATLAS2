...
func TestEntityStore_ListEntitiesPagination(t *testing.T) {
	pool := testPool(t)
	defer pool.Close()
...
func TestObjectStore_ListObjectsPagination(t *testing.T) {
	pool := testPool(t)
	defer pool.Close()
...
func TestTaskStore_ListTasksPagination(t *testing.T) {
	pool := testPool(t)
	defer pool.Close()
...
func TestObservationStore_ListObservationsPagination(t *testing.T) {
	pool := testPool(t)
	defer pool.Close()
