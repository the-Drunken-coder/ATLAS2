...
Open backlog items are numbered **10** only. Findings **08** and **09** are resolved (2026-05-18).
...
| Functions server god object (file split) | [08](08-functions-server-god-object.md) — resolved 2026-05-18 |
| Postgres test skips vs CI (fail by default) | [09](09-postgres-test-skips-ci-reality.md) — resolved 2026-05-18 |
