...
- **Functions capabilities:** internal platform mutations and queries; protocol validation; task runtime validation that joins stored asset/catalog state; idempotency semantics; publication of successful domain mutations; subscription RPCs for mutation delivery.
